...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @kingvj01
        ...
        buttons = [[
             ...
             InlineKeyboardButton('ᴇᴀʀɴ ᴍᴏɴᴇʏ Opss...', callback_data='shortlink_info')
         ], [
        ...
        buttons = [[
            InlineKeyboardButton('‼️ Dɪsᴄʟᴀɪᴍᴇʀ ‼️', url="https://telegra.ph/AIO-Movies-Bot-Disclaimer-11-09")
        ],[
        ...
        await query.message.edit_text(
            ...
            btn = [[
                InlineKeyboardButton("Opss...ERROR", callback_data="laninfo")
        ], [
            InlineKeyboardButton("Not Working...", callback_data="tamil_info"),
            InlineKeyboardButton("Not Working...", callback_data="english_info"),
            InlineKeyboardButton("Not Working...", callback_data="hindi_info")
        ], [
            InlineKeyboardButton("Not Working...", callback_data="malayalam_info"),
            InlineKeyboardButton("Not Working...", callback_data="urdu_info"),
            InlineKeyboardButton("Not Working...", callback_data="bangladesh_info")
        ], [
            InlineKeyboardButton("Not Working...", callback_data="telugu_info"),
            InlineKeyboardButton("Not Working...", callback_data="kannada_info"),
            InlineKeyboardButton("Not Working...", callback_data="gujarati_info")
        ], [
            InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="start")
...
async def auto_filter(client, name, msg, reply_msg, ai_search, spoll=False):
    ...
    if settings["button"]:
        ...
        btn.insert(0, [
            InlineKeyboardButton("sᴇɴᴅ ᴀʟʟ ɴᴏᴡ", callback_data=f"sendfiles#{key}"),
            InlineKeyboardButton("ʟᴀɴɢᴜᴀɢᴇs", callback_data=f"languages#{key}"),
            InlineKeyboardButton("ʏᴇᴀʀs", callback_data=f"years#{key}")
        ])
    else:
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text="𝗧𝗛𝗘 𝗘𝗡𝗗",callback_data="pages")]
        )
